...
import type { BookMetadata as _BookMetadata, ExternalBlob as _ExternalBlob, ReadingProgress as _ReadingProgress, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addBookToLibrary(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addBookToLibrary(arg0, arg1, arg2, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addBookmark(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async bookExists(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.bookExists(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteBookByTitle(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteBookByTitle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllReadingProgress(): Promise<Array<[string, ReadingProgress]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllReadingProgress();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBookProgress(arg0: string): Promise<ReadingProgress | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookProgress(arg0);
    ...
    async getPublicBooks(): Promise<Array<Book>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPublicBooks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserLibrary(arg0: Principal): Promise<Array<BookMetadata>> {
        if (this.processError) {
            try {
    ...
    async hasBook(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasBook(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initBooks(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initBooks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeBookFromLibrary(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeBookFromLibrary(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeBookmark(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateBookProgress(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBookProgress(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_BookMetadata_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BookMetadata): Promise<BookMetadata> {
...
function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ReadingProgress]): ReadingProgress | null {
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        externalBlob: await from_candid_ExternalBlob_n18(_uploadFile, _downloadFile, value.externalBlob),
        author: value.author
    };
}
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BookMetadata>): Promise<Array<BookMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_BookMetadata_n16(_uploadFile, _downloadFile, x)));
}
